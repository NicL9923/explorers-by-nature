...
def cow():
 ...
 e('Ribcage',(0,.05,1.13),(.40,.76,.42));e('Barrel',(0,.18,1.02),(.41,.54,.39));e('Withers',(0,-.43,1.35),(.29,.28,.31));e('Rump',(0,.61,1.22),(.36,.30,.34))
 e('Neck',(0,-.62,1.36),(.255,.34,.35));e('Raised neck',(0,-.77,1.48),(.205,.24,.33))
 e('Skull',(0,-.95,1.61),(.218,.225,.27));e('Face bridge',(0,-1.09,1.43),(.18,.22,.28));e('Jaw',(0,-1.025,1.35),(.205,.19,.19))
 ...
 body=sculpt(parts,'Clover continuous sculpt',.021,11000)
 bake_coat(body)
