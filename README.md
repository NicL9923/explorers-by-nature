...
Pinewatch now includes modular homesteads, decorative flowers, cow milking, egg gathering, a shared pantry, saved worlds, and private dedicated-server multiplayer. Explore the meadow, aspen grove, river and mountain overlook with deer, rabbits, mallards, beavers, foxes and birds. Seven animal species now have skinned animation. Pack a picnic, visit the overlook, and bring home alpine flowers. Sit on benches, furnish the ranch, and enjoy gentle rain, evening lanterns and spatial nature audio. Original Blender models furnish the ranch, trees and wildlife, with simpler meshes for distant views. See the [art gallery](docs/art-pass.md).
...
[Download the Linux or Windows prototype](https://github.com/NicL9923/explorers-by-nature/releases/tag/v0.6.0-polish.1). Linux was exercised on NVIDIA and AMD integrated graphics; the Windows build has not been run on Windows yet.

[See the complete picnic and nature polish pass](docs/picnic-polish.md).
