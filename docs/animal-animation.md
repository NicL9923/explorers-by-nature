...
All seven original animals now use Blender-authored skin weights and compact skeletons. Both imported LOD meshes share the same skeleton and retain their original topology, UVs and material slots. The Unity controller moves bones; it does not rebuild mesh vertices every frame.
...
Run the relevant original art generator first when changing anatomy, then:
